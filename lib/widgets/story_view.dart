...
class StoryViewState extends State<StoryView> with TickerProviderStateMixin {
  ...
  void _goBack() {
    ...
    if (this._currentStory == widget.storyItems.first) {
      ...
      widget.onStoryChange?.call(previous);
  ...
  void _goForward() {
    if (this._currentStory != widget.storyItems.last) {
      ...
      if (_last != null) {
        _last.shown = true;
        widget.onStoryChange?.call(_last);
  ...
  Widget build(BuildContext context) {
    return CustomPaint(
      ...
      foregroundPainter: IndicatorOval(
        indicatorColor == null ? Colors.white.withOpacity(0.8) : indicatorColor!,
        this.value,
      ),
      painter: IndicatorOval(
        indicatorBackColor == null ? Colors.white.withOpacity(0.4) : indicatorBackColor!,
        1.0,
      ),
    );
  }
